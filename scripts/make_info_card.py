...
# ===========================================================================
HOST = "ianuj-yadav"   # shown as  ianuj-yadav@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "AI Engineer Intern @ Binarysoft Tech"),
    ("kv", "Prev", "Data Analyst Virtual Intern @ Deloitte"),
    ("kv", "Also", "Open Source Contributor @ ELUSOC"),
    ("kv", "Edu", "B.Tech CSE, Amity University '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, Java, JavaScript, Data Structures"),
    ("kv", "Web Dev", "React.js, Node.js, Express, REST APIs"),
    ("kv", "AI / Cloud", "GenAI, Prompt Engineering, AWS, Azure"),
    ("kv", "Databases", "PostgreSQL, SQL, Git, GitHub"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built TDL GPT: AI-powered 4GL code generator"),
    ("bul", "Built Notes-Elitehub & Visual DSA Platform"),
    ("bul", "2nd Rank in Science Olympiad & AWS AI Certified"),
]
