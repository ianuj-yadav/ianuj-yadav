...
CONTRAST = 1.15
BRIGHTNESS = 0.96
GAMMA = 0.92          # >1 brightens mids -> face lands in sparser chars
SHARPEN = True
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">ianuj-yadav@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'ianuj-yadav@github:~$ whoami <tspan fill="{INK}">Anuj Yadav</tspan></text>')
